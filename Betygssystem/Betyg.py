...
def main():
    ...
    print("Antalet studenter med betyget Underkänt: " + str(ickeGodkant) + " (" + str(
        format(procentsats, '0.1f')) + " %)")
    ...
    print("Antalet studenter med betyget Mycket Väl Godkänt: " + str(mvg) + " (" + str(
        format(procentsats, '0.1f')) + " %)")
